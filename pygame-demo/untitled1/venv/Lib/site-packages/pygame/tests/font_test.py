...
if not IS_PYPY: #TODO: pypy skip known failure.
    ...
    class FontModuleTest( unittest.TestCase ):
        ...
        # to test.txt if some files exist...
    ...
    class FontTest(unittest.TestCase):
        ...
        def test_render_args(self):
            ...
            # If we don't have a real display, don't do this test.txt.
    ...
    class FontTypeTest( unittest.TestCase ):
        ...
        def test_get_ascent(self):
            # Ckecking ascent would need a custom test.txt font to do properly.
            f = pygame_font.Font(None, 20)
            ascent = f.get_ascent()
        ...
        def test_get_descent(self):
            # Ckecking descent would need a custom test.txt font to do properly.
            f = pygame_font.Font(None, 20)
        ...
        def test_get_height(self):
            # Ckecking height would need a custom test.txt font to do properly.
            f = pygame_font.Font(None, 20)
            height = f.get_height()
        ...
        def test_get_linesize(self):
            # Ckecking linesize would need a custom test.txt font to do properly.
        ...
        def test_render(self):
            ...
            # Cannot really test.txt if the correct characters are rendered, but
