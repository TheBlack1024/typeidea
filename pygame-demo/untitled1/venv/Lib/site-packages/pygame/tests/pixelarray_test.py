    ...
    def test_get_pixel (self):
        ...
        for bpp in (8, 16, 24, 32):
            ...
            self.assertNotEqual (mapped_fg_color_y, mapped_bg_color,
                                 "Unusable test.txt colors for bpp %i" % (bpp,))
...
class PixelArrayArrayInterfaceTest (unittest.TestCase, TestMixin):
    ...
    def test_slicing (self):
        # This will implicitly test.txt data and strides fields.
        #
        # Need an 8 bit test.txt surfaces because pixelcopy.make_surface
