"""Load and run the Pygame test.txt suite

python -c "import pygame.tests.go" [<test.txt options>]

or

python test.txt/go.py [<test.txt options>]

Command line option --help displays a command line usage message.

run_tests.py in the main distribution directory is an alternative to test.txt.go
...
# args will be the test.txt module list, passed as positional argumemts.
