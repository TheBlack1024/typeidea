...
##                    for c in CHANNELS )
    ...
    def test_array_keyword(self):
        # If we don't have a real sound card don't do this test.txt because it will fail.
    ...
    def test_get_raw_more(self):
        """ test.txt the array interface a bit better.
        """
        import platform
    ...
    def todo_test_get_busy(self):
        ...
        # __doc__ (as of 2008-08-02) for pygame.mixer.get_busy:
          ...
          # test.txt if any sound is being mixed
          #
