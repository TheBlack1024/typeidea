...
class TransformModuleTest( unittest.TestCase ):
    ...
    def test_threshold_dest_surf_not_change(self):
        ...
        So there should be none changed in this test.txt.
        """
        (w, h) = size = (32, 32)
        threshold = (20, 20, 20, 20)
        original_color = (25, 25, 25, 25)
...
#XXX
    ...
    def test_threshold__surface(self):
        ...
        if 1:
            # test.txt end markers.  0, and 255
    ...
    def test_get_smoothscale_backend(self):
        ...
        # It would be nice to test.txt if a non-generic type corresponds to an x86
        # processor. But there is no simple test.txt for this. platform.machine()
