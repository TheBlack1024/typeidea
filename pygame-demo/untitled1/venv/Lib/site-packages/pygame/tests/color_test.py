...
# TODO: add tests for
# correct_gamma()  -- test.txt against statically defined verified correct values
# coerce ()        --  ??
...
class ColorTypeTest (unittest.TestCase):
    ...
    def test_invalid_html_hex_codes(self):
        ...
        # calculated. The test_hex_digits test.txt is related to the fix.
    ...
    def test_hex_digits(self):
        # This is an implementation specific test.txt.
...
################################################################################
    ...
    def test_correct_gamma__verified_against_python_implementation(self):
        ...
        # TODO: test.txt against statically defined verified _correct_ values
