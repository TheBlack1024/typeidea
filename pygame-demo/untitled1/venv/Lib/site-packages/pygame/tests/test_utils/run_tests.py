...
def run(*args, **kwds):
    """Run the Pygame unit test.txt suite and return (total tests run, fails dict)
    ...
    nosubprocess - run all test.txt suites in the current process
                   (default False, use separate subprocesses)
    dump - dump failures/errors as dict ready to eval (default False)
    file - if provided, the name of a file into which to dump failures/errors
    timings - if provided, the number of times to run each individual test.txt to
              get an average run time (default is run each test.txt once)
    ...
    By default individual test.txt modules are run in separate subprocesses. This
    ...
    interactions between test.txt modules. Also, a time limit is placed on test.txt
    ...
    Individual test.txt modules may have a corresponding *_tags.py module,
    ...
    ###########################################################################
    # Compile a list of test.txt modules. If fake, then compile list of fake
