...
class ImageModuleTest( unittest.TestCase ):
    ...
    def test_save(self):
        ...
        for fmt in formats:
            try:
                ...
                # test.txt the magic numbers at the start of the file to ensure they are saved
    ...
    def test_to_string__premultiplied(self):
        """ test.txt to make sure we can export a surface to a premultiplied alpha string
        """
    ...
    def todo_test_get_extended(self):
        ...
        # __doc__ (as of 2008-08-02) for pygame.image.get_extended:
          ...
          # test.txt if extended image formats can be loaded
          # 
